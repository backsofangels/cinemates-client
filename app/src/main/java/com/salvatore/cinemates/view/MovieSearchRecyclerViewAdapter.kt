...
class MovieSearchRecyclerViewAdapter(private val dataSet: ArrayList<MovieSearchResultDto>): RecyclerView.Adapter<MovieSearchRecyclerViewViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MovieSearchRecyclerViewViewHolder {
        ...
        return MovieSearchRecyclerViewViewHolder(view).listen { pos, _ ->
